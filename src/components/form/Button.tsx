...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-[12px] text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 font-sfpro",
  {
    variants: {
      variant: {
      ...
      size: {
        ...
        sm: "h-10 px-4 py-[10px] text-sm font-medium",
        md: "h-[52px] px-5 py-3 text-sm font-medium",
        lg: "h-14 px-5 py-3 text-base font-normal",
        icon: "h-10 w-10",
        link: "px-0 py-2",
      },
    },
