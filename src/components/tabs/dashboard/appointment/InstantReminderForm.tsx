...
import { instantAppointmentReminderSchema } from "@/schemas";
import {
...
export const InstantAppointmentReminderForm = ({
  isOpen,
  onOpenChange,
  appointment,
  ...
  const validation = useFormik({
    ...
    initialValues,
    validationSchema: instantAppointmentReminderSchema,
    onSubmit: (values) => {
      if (!appointment) {
      ...
      dispatch(
        sendInstantReminder({ data: values as any, source: "appointment" })
      );
    },
  });
  ...
  return (
    <FormDialog
      ...
      description="Send an instant reminder to your meeting guest."
