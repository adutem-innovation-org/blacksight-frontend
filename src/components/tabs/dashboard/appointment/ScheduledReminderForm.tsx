...
import { Appointment, IBCP } from "@/interfaces";
import { scheduledAppointmentReminderSchema } from "@/schemas";
import {
...
export const ScheduledAppointmentReminderForm = ({
  isOpen,
  onOpenChange,
  appointment,
  ...
  const validation = useFormik({
    ...
    initialValues,
    validationSchema: scheduledAppointmentReminderSchema,
    onSubmit: (values) => {
      ...
      dispatch(
        createScheduledReminder({ data: values, source: "appointment" })
      );
    },
  });
    ...
    return templates && templates.length > 0
      ? templates.reduce((acc, template) => {
          if (
            ...
            (template.category as unknown as ReminderCategory) ===
